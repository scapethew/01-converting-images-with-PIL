This is the first sample problem/program from the final course of the Google IT Automation w/ Python certification.

I'm also practicing git with all of my future projects, and will be committing when I believe I have the solution, then committing with my updates as I fix edge-cases/errors for tracking.
